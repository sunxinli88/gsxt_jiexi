package com.gxst.service.zhejiang.jiexi;
...
public class JiexiZhejiang {
	...
	public static void getCol() {
		List<Map<String, Object>> htmls = db_local3
				.excuteQuery("select company_text,keyword,company_no,company_name from company_zhejiang_text", null);
