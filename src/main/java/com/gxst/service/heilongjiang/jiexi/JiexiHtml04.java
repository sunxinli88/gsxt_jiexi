...
public class JiexiHtml04 {
	...
	public static void jiexi() {
		List<Map<String, Object>> htmls = Paramters.db_local
				.excuteQuery("select html_tab04_text,keyword,company_no,company_name from company_hlj", null);

		for (Map<String, Object> html : htmls) {

			if (html.get("html_tab04_text") == null) {
				continue;
			}
			String disposerRealName = ToDBC.tool(html.get("company_name").toString());

			String mainHtml = html.get("html_tab04_text").toString();
